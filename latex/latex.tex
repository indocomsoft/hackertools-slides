...
\date{5 November 2019 \\ Slides at \url{https://is.gd/2019ht6slides} \\ Download data at \url{https://is.gd/2019ht6data}}
...
\begin{frame}{What can I use \LaTeX{} for?}
  \begin{itemize}
    \item Reports
    \item Books
    \item Presentation\footnote{This presentation is written in \LaTeX!}
...
\texttt{teletype font family (monospaced font)}
\textbf{bold fontface}
...
\begin{frame}[fragile]{Adding paragraph skips}
  \begin{itemize}
    \item To make paragraphs boundary clearn using zero indentation, vertical space between paragraphs is needed.
...
\begin{frame}[fragile]{Typesetting URLs}
  Use the \texttt{hyperref} package, with the \mintinline{latex}{\url{https://pinda.fun}} command
...
\end{equation}
  ...
  However, if you want to get an inline formula, there exists a shorthand:
  \begin{minted}{latex}
$e^{i \pi} + 1 = 0$
  \end{minted}
...
\begin{frame}[fragile]{Sums and Integrals}
  ...
  Use \mintinline{latex}{\limits} if you want the limits specified above and below the symbol
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item This is the last in the Hacker Tools series this semester
  \end{itemize}
\end{frame}
