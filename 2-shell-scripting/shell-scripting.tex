...
\date{8 September 2020 \\ Slides at TODO}%\url{https://is.gd/2020ht5slides}}
...
\begin{frame}
  ...
  \begin{itemize}
    \item \textbf{Feedback form}: TODO %\url{https://is.gd/2019ht5}
    \item \textbf{Upcoming Hacker Tools}:

          Data Wrangling, 22nd September 2020, 6.30pm
  \end{itemize}
\end{frame}
